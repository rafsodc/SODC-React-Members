import { addElement, removeElementByIndex, removeElementByValue, updateObject } from '../helpers/utility'
...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.CLEAR_ALERT:
      return clearAlert(state, action)
    case actionTypes.CLEAR_UNSTICKY_ALERTS:
      return clearUnstickyAlert(state)
    default:
      return state
  }
}
